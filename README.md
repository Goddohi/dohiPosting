...
- 회원가입 기능
  ...
  - 회원가입시 이메일(아이디)과 패스워드를 입력받으며, 이메일은 unique 해야한다.
  - 이메일인증을 통해 이메일에 대한 신뢰성을 올린다. 
...
- 게시글 삭제 기능
  - 게시글은 운영자와 게시글 작성자만 삭제가 가능하다.
  - 삭제시 게시글에 관련된 댓글은 전체 삭제가 된다.
...
- 댓글 삭제 기능
  - 댓글 삭제는 댓글 작성자와 운영자, 게시글 작성자만 삭제가 가능하다. 
